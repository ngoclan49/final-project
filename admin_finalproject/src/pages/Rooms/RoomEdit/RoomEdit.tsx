...
import {
  roomValidation,
  validationToggle,
} from '../../../util/validation/roomValidation';
...
const RoomEdit = (props: Props) => {
  ...
  const {
    ...
    poolToggle,
    parkingToggle,
  } = useSelector((state: RootState) => state.toggleReducer);
    ...
    <>
      ...
      <div className='formEidt'>
        <form
          ...
          className='roomCreate-body roomEdit-body'
        >
          <FormRoom
          ...
          <div className='roomCreated-button-wrap'>
            <button type='submit' className='roomCreated-button'>
              Submit
            </button>
          </div>
        </form>
